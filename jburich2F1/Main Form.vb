...
Public Class frmMain
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click
        ...
        Const dblDAILY_ROOM_CHG_QUEEN_AUTRIUM As Double = 275
        Const dblDAILY_ROOM_CHG_KING_STAND As Double = 245.5
        Const dblDAILY_ROOM_CHG_KING_AUTRIUM As Double = 325
        ...
        If blnIsRoomReservedOK AndAlso blnIsNightsOK AndAlso blnIsAdultsOK Then
            ...
            'calculate and dislpay the charges
            ...
            Else
                ...
                If radQueen.Checked Then
                    ...
                    Else
                        dblDailyRoomCharge = dblDAILY_ROOM_CHG_QUEEN_AUTRIUM
                    End If
                Else
                    If radStandard.Checked Then
                        dblDailyRoomCharge = dblDAILY_ROOM_CHG_KING_STAND
                    Else
                        dblDailyRoomCharge = dblDAILY_ROOM_CHG_KING_AUTRIUM
                    End If
                End If
    ...
    Private Sub txtRooms_KeyPress(sender As Object, e As KeyPressEventArgs) _
    ...
    Private Sub txtNights_Enter(sender As Object, e As EventArgs) Handles txtRooms.Enter
        txtNights.SelectAll()
    End Sub

    Private Sub txtAdults_Enter(sender As Object, e As EventArgs) Handles txtRooms.Enter
        txtAdults.SelectAll()
    End Sub
